...
/**
 * Spring AI tools exposed to the customer-service assistant for course consultation.
 */
...
public class CourseTools {
    ...
    /**
     * Queries courses by type, education requirement, and allowed sort fields.
     *
     * @param query course query generated by the model
     * @return courses matching the query conditions
     */
    ...
    /**
     * Converts model-provided sort field names to whitelisted database columns.
     */
    ...
    /**
     * Queries all campuses that can host trial classes.
     *
    ...
    /**
     * Creates a course trial reservation from model-collected user information.
     *
     * @param course reserved course name
     * @param studentName student name
     * @param contactInfo contact details
     * @param school reserved campus
     * @param remark optional reservation remark
